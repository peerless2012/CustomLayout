...
import com.peerless2012.customlayout.R;
...
public class PercentFrameLayout extends FrameLayout {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (mHeightPercent > 0) {
			super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((int)(height * mHeightPercent), heightMode));
		}else if (mWidthPercent > 0) {
			super.onMeasure(MeasureSpec.makeMeasureSpec((int)(width * mWidthPercent), widthMode),heightMeasureSpec);
		}else {
